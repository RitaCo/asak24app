...
<div class=" flex flex-col items-center  h-full overflow-hidden text-gray-400 bg-gray-800 ">
    <a class="flex items-center w-full px-3 mt-3" href="#">
        ...
        <span class="ml-2 text-sm font-bold">مدیریت آساک</span>
    </a>
    <div class="w-full px-2">
        <div class="flex flex-col items-center w-full mt-3 border-t border-gray-600">
            ...
            <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-600 hover:text-gray-300" href="#">
                ...
                <span class="ml-2 text-sm font-medium">گروه‌ محصولات</span>
            </a>
        ...
        <div class="flex flex-col items-center w-full mt-2 border-t border-gray-600">
            <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-600 hover:text-gray-300" href="#">
                <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a class="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-600 hover:text-gray-300" href="#">
                <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <a class="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-600 hover:text-gray-300" href="#">
        <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
