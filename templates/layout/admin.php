...
<div id="root">
    <nav class="md:right-0 md:block md:fixed md:top-0 md:bottom-0 md:nooverflow md:flex-row md:flex-nowrap md:overflow-hidden shadow-2xl ">
     <?= $this->element('Admin/sidebar-left'); ?>
    </nav>
    <div class="relative md:mr-64 bg-blueGray-50">
        <nav
