...
namespace PHPSTORM_META {
	...
	override(
		...
		map([
			'AssetMix' => \Cake\Http\BaseApplication::class,
			...
			'CakeDC/Auth' => \Cake\Http\BaseApplication::class,
			'CakeDC/Users' => \Cake\Http\BaseApplication::class,
	...
	override(
		...
		map([
			'AssetMix.AssetMix' => \AssetMix\View\Helper\AssetMixHelper::class,
